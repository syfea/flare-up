...
class Article
{
     ...
     * @var string
     *
     * @ORM\Column(name="smallContent", type="text", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="countView", type="decimal", precision=3, scale=0, nullable=true)
     */
    private $countView;
    ...
    public function getUrl()
    {
        ...
        if ($this->id != 0) {
            ...
            $str = strtr($this->title, $CHARACTER_REPLACE_URL);
            $str = str_replace(' ', '-', $str);
